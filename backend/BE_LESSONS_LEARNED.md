...
This is set up through a Class setup with the @Configuration annotation. See the WebConfig class file in "backend/src/main/java/com/kendev131/task_manager/config"